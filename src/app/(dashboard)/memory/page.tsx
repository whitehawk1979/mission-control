...
import { Eye, Edit3, RefreshCw, Brain, Box } from "lucide-react";
import { FileTree, FileNode } from "@/components/FileTree";
import { MarkdownEditor } from "@/components/MarkdownEditor";
import { MarkdownPreview } from "@/components/MarkdownPreview";
import { ObsidianGraph2D } from "@/components/ObsidianGraph2D";
  ...
  () => import("@/components/MemoryGraph3D"),
  {
    ...
    loading: () => (
      <div style={{
        ...
        `}</style>
        <div style={{ fontSize: "14px" }}>Loading 3D Graph...</div>
      </div>
    ),
  }
);
...
type TabMode = "files" | "graph2d" | "graph3d";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ display: "flex", gap: "8px", padding: "0 24px 16px" }}>
        <button
          ...
          style={{
            ...
            padding: "8px 16px",
            borderRadius: "8px",
            backgroundColor: tabMode === "files" ? "var(--accent)" : "var(--card)",
            color: tabMode === "files" ? "var(--bg, #111)" : "var(--text-secondary)",
        ...
        <button
          ...
          style={{
            ...
            padding: "8px 16px",
            borderRadius: "8px",
            backgroundColor: tabMode === "graph2d" ? "var(--accent)" : "var(--card)",
            color: tabMode === "graph2d" ? "var(--bg, #111)" : "var(--text-secondary)",
            border: "1px solid var(--border)",
            cursor: "pointer",
            fontSize: "13px",
            fontWeight: 600,
        ...
        <button
          ...
          style={{
            ...
            padding: "8px 16px",
            borderRadius: "8px",
            backgroundColor: tabMode === "graph3d" ? "var(--accent)" : "var(--card)",
            color: tabMode === "graph3d" ? "var(--bg, #111)" : "var(--text-secondary)",
            border: "1px solid var(--border)",
            cursor: "pointer",
            fontSize: "13px",
            fontWeight: 600,
      ...
      {tabMode === "graph3d" ? (
        ...
        /* Two-column layout for Files tab */
        <div
          style={{
            display: "flex",
            flex: 1,
